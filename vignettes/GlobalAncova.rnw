...
%\begin{itemize}
%\item 
The testing of collections of functional gene sets (Gene Ontology, KEGG, Broad Institute's gene sets) was
...
<<gakegg, message=F>>=
GAKEGG(xx=exprs(golubX), formula.full=~ALL.AML, formula.red=~1, 
       model.dat=pData(golubX), id=c("04110", "04210"), 
       annotation="hu6800", multtest="BH")
@
