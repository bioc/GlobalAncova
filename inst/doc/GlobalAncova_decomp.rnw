% \VignetteIndexEntry{GlobalAncova.decomp}
% \VignetteDepends{GlobalAncova}
% \VignetteKeywords{Expression Analysis}
% \VignettePackage{GlobalAncova.decomp}
...
The following examples are based on the van’t Veer breast cancer data set, which is included in the \Rpackage{GlobalAncova} package. 
